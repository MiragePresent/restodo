...
--
-- Host: localhost    Database: restodo
-- ------------------------------------------------------
...
CREATE TABLE `tasks` (
                       ...
                       `due_date` timestamp(4) NOT NULL DEFAULT CURRENT_TIMESTAMP(4) ON UPDATE CURRENT_TIMESTAMP(4),
...
CREATE TABLE `user_tokens` (
                             ...
                             KEY `user_tokens_token_index` (`token`),
...
-- Dump completed on 2019-03-27 23:49:37
